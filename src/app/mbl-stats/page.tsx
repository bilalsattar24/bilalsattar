...
export const metadata: Metadata = {
  ...
  description: 'Dive deep into MBL player stats. Search, filter, and explore comprehensive career statistics for every player, season, and division in a beautiful, responsive interface.',
};
