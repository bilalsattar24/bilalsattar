  ...
  const filteredData = useMemo(() => {
    return data.filter(player => {
      ...
      const searchMatch = searchTerm === '' || 
        player['First Name']?.toLowerCase().includes(searchTerm.toLowerCase()) ||
      ...
      <Container maxWidth="xl">
        ...
        >
          <Box sx={{ textAlign: 'center', mb: 6 }}>
            ...
            >
              <SportsIcon sx={{ fontSize: 'inherit', mr: 2, verticalAlign: 'middle' }} />
              MBL Player Stats
            </Typography>
            <Typography 
              variant="h6" 
        ...
        <Box sx={{ textAlign: 'center', mt: 6, color: 'white' }}>
          <Typography variant="body2" sx={{ opacity: 0.8 }}>
            MBL Player Statistics Dashboard • {filteredData.length} players displayed
          </Typography>
        </Box>
      </Container>
    </Box>
